...
class RolloutStorage:
    ...
    def __init__(self, num_envs, buffer_size, obs_shape, states_shape, actions_shape, device='cpu', sampler='sequential'):
        ...
        self.future_observations = torch.zeros(buffer_size, num_envs, *obs_shape, device=self.device)
    ...
    def add_transitions(self, observations, actions, rewards, dones, future_observations=None):
        ...
        if future_observations is not None:
            self.future_observations[self.step].copy_(future_observations)
