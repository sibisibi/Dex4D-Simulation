...
ROBOT_RAW_BASES = {
    "xarm6_leap_description": (
        "https://raw.githubusercontent.com/sibisibi/Dex4D-Simulation/master/"
        "dex4d_policy/assets/urdf/xarm6_leap_description/"
    ),
    "fr3_xhand": (
        "https://raw.githubusercontent.com/sibisibi/Dex4D-Simulation/master/"
        "dex4d_policy/assets/urdf/fr3_xhand_description/fr3_xhand/"
    ),
}

# https://github.com/DAVIAN-Robotics/simtoolreal/blob/main/isaacsimenvs/tasks/simtoolreal/pose_viewer.py
GOAL_COLOR = (0.20, 0.72, 0.31)
