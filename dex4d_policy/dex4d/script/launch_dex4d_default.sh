#!/bin/bash
# Stock Dex4D teacher PPO stage 1&2, wandb draftrec/play as dex4d-default_<ts>.
# 018 re-run: pose-viewer media logged from iteration 0, GPU as $1 (yj-3 GPU 0 default).
set -e
cd "$(dirname "$0")/.."
