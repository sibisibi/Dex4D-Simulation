...
class PointNet2Module(nn.Module):
    ...
    def __init__(self, cfg: Config, output_dim: int, norm: str = 'bn'):
        super().__init__()
        self.cfg = cfg
...
if __name__ == "__main__":
    ...
    cfg = OmegaConf.load('cfg/pointnet2/pointnet2.yaml')
    ...
    model = PointNet2Module(pointnet_config, cfg.output_dim)
    print(model)
    ...
    y = model(x)
    print(y.shape) # should be [2, 16, 128]
